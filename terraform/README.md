...
```bash
git clone https://github.com/evalsocket/ontherocks.git
cd ontherocks/terraform

# Set ENV variable
export MONGODB_PASSWORD=
export MONGOROOTPASSWORD=
...
- [x] It will setup EKS Claster
- [x] It Will create namespaces (dev/prod/database/cert-manager)
- [x] It will Setup Mongodb v4 and create secret for services in dev and prod
- [x] It will export kubeconfig.yaml in `terraform/export` and upload in bucket
- [x] It will setyp helm and install cert-manager and ngnix-ingress
...
- [terraform-aws-eks-workers](https://github.com/cloudposse/terraform-aws-eks-workers)
